...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB0     ------> ADC1_IN8
    */
    HAL_GPIO_DeInit(GPIOC, PAD5_Pin|PAD4_Pin|PAD6_Pin|PAD7_Pin);

    HAL_GPIO_DeInit(GPIOA, PAD1_Pin|PAD2_Pin|PAD8_Pin|SPARE1_Pin
                          |SPARE2_Pin);

    HAL_GPIO_DeInit(PAD3_GPIO_Port, PAD3_Pin);
